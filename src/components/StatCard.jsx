      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col w-full mb-20 text-center">
          <h1 className="mb-4 text-2xl font-medium text-gray-900 sm:text-3xl title-font">
            Explore BuyAnything Statistics
          </h1>
          <p className="mx-auto text-base leading-relaxed lg:w-2/3">
            Discover the impact of BuyAnything in numbers. From downloads to
            users, here's how we're making a difference.
          </p>
        </div>
          ...
          <div className="w-full p-4 md:w-1/4 sm:w-1/2">
            <div className="px-4 py-6 border-2 border-gray-200 rounded-lg">
              <svg
                ...
                strokeWidth="2"
                className="inline-block w-12 h-12 mb-3 text-purple-500"
                viewBox="0 0 24 24"
              >
